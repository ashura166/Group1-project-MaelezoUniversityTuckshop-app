...
class TuckShopApp:
    ...
    def __init__(self, root):
        ...
        # Login Frame: Centered with padding

        self.login_frame = tk.Frame(self.root, bg='lightblue')  # Set background color

        self.login_frame.pack(pady=100, padx=150, anchor='center')  # Center the frame with padding


        # Username Label and Entry (Center aligned)
        ...
        # Password Label and Entry (Center aligned)
    ...
    def create_main_frame(self):
        ...
        self.main_frame = tk.Frame(self.root, bg='lightblue')  # Set background color
